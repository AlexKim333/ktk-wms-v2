    ...
    <div class="table-wrapper">
      <table class="history-table">
        ...
        <tbody>
          ...
          <tr v-if="filteredOutboundHistorys.length === 0">
      ...
      <div class="modal-content modal-large">
        ...
        <div class="modal-body">
          <div class="detail-grid">
            ...
            <div class="detail-card">
              <label>생성일</label>
              <div class="val">{{ selectedOutboundHistory.creation ? selectedOutboundHistory.creation.split(' ')[0] : '' }}</div>
            </div>
          </div>
          ...
          <div class="compare-tables">
            <div class="compare-section">
              ...
              <table class="detail-items-table">
                ...
                <tbody>
                  <tr v-for="item in selectedOutboundHistoryItems" :key="item.name">
...
const fetchOutboundHistorys = async () => {
  try {
...
onMounted(() => {
  fetchOutboundHistorys()
})

const filteredOutboundHistorys = computed(() => {
...
const openDetail = async (res) => {
  selectedOutboundHistory.value = res
...
const goToPreviousHistory = () => {
  if (!selectedOutboundHistory.value) return
  const list = filteredOutboundHistorys.value
  const index = list.findIndex(r => r.name === selectedOutboundHistory.value.name)
...
const loadToCart = () => {
  emit('edit-history', {
    ...selectedOutboundHistory.value,
    items: selectedOutboundHistoryItems.value,
    sourceNav: 'outbound-history'
  })
  selectedOutboundHistory.value = null
}
</script>
